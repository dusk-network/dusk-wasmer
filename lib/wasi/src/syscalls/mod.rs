...
fn write_bytes_inner<T: Write, M: MemorySize, D>(
    ctx: &ContextMut<'_, WasiEnv, D>,
    mut write_loc: T,
    memory: &Memory,
...
pub(crate) fn write_bytes<T: Write, M: MemorySize, D>(
    ctx: &ContextMut<'_, WasiEnv, D>,
    mut write_loc: T,
    memory: &Memory,
    iovs_arr: WasmSlice<__wasi_ciovec_t<M>>,
) -> Result<usize, __wasi_errno_t> {
    let result = write_bytes_inner::<_, M, D>(ctx, &mut write_loc, memory, iovs_arr);
    write_loc.flush();
    result
}

pub(crate) fn read_bytes<T: Read, M: MemorySize, D>(
    ctx: &ContextMut<'_, WasiEnv, D>,
    mut reader: T,
    memory: &Memory,
...
#[must_use]
fn write_buffer_array<M: MemorySize, D>(
    ctx: &ContextMut<'_, WasiEnv, D>,
    memory: &Memory,
    from: &[Vec<u8>],
...
///
pub fn args_get<M: MemorySize, D>(
    mut ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn args_sizes_get<M: MemorySize, D>(
    mut ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn clock_res_get<M: MemorySize, D>(
    mut ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn clock_time_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    clock_id: __wasi_clockid_t,
...
pub fn environ_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn environ_sizes_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
/// - `__WASI_EBADF`
///     If `fd` is invalid or not ope<D>n
pub fn fd_close<D>(ctx: ContextMut<'_, WasiEnv, D>, fd: __wasi_fd_t) -> __wasi_errno_t {
...
/// Inputs:
/// - `__wasi_fd_t fd`
///     The file descriptor to syn<D>c
pub fn fd_datasync<D>(ctx: ContextMut<'_, WasiEnv, D>, fd: __wasi_fd_t) -> __wasi_errno_t {
...
pub fn fd_fdstat_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_filestat_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_filestat_set_times<D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_pread<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_prestat_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_prestat_dir_name<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    path: WasmPtr<u8, M>,
    path_len: M::Offset,
...
pub fn fd_pwrite<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn fd_readdir<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    buf: WasmPtr<u8, M>,
    buf_len: M::Offset,
...
pub fn fd_event<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    initial_val: u64,
...
/// - `__WASI_EPERM`
/// - `__WASI_ENOTCAPABLE<D>`
pub fn fd_sync<D>(ctx: ContextMut<'_, WasiEnv, D>, fd: __wasi_fd_t) -> __wasi_errno_t {
    debug!("wasi::fd_sync");
    debug!("=> fd={}", fd);
    let env = ctx.state();
    let (_, mut state, inodes) = env.get_memory_and_wasi_state_and_inodes(0);
...
/// Errors:
///
pub fn fd_write<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    iovs: WasmPtr<__wasi_ciovec_t<M>, M>,
    iovs_len: M::Offset,
...
pub fn path_create_directory<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    path: WasmPtr<u8, M>,
    path_len: M::Offset,
...
pub fn path_filestat_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
...
pub fn path_filestat_set_times<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    flags: __wasi_lookupflags_t,
    path: WasmPtr<u8, M>,
...
pub fn path_link<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    old_fd: __wasi_fd_t,
...
pub fn path_open<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    dirfd: __wasi_fd_t,
...
pub fn path_readlink<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    dir_fd: __wasi_fd_t,
    path: WasmPtr<u8, M>,
    path_len: M::Offset,
...
pub fn path_remove_directory<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    path: WasmPtr<u8, M>,
    path_len: M::Offset,
...
pub fn path_rename<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    old_fd: __wasi_fd_t,
    old_path: WasmPtr<u8, M>,
    old_path_len: M::Offset,
...
/// - `u32 new_path_len`
///     The number of bytes to read from `new_path`
pub fn path_symlink<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    old_path: WasmPtr<u8, M>,
    old_path_len: M::Offset,
    fd: __wasi_fd_t,
...
pub fn path_unlink_file<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    fd: __wasi_fd_t,
    path: WasmPtr<u8, M>,
    path_len: M::Offset,
...
pub fn poll_oneoff<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
/// Inputs:
/// - `__wasi_signal_t`
///   Signal to be raised for this proces<D>s
pub fn proc_raise<D>(ctx: ContextMut<'_, WasiEnv, D>, sig: __wasi_signal_t) -> __wasi_errno_t {
...
pub fn sched_yield<D>(ctx: ContextMut<'_, WasiEnv, D>) -> Result<__wasi_errno_t, WasiError> {
...
pub fn random_get<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    buf: WasmPtr<u8, M>,
    buf_len: M::Offset,
) -> __wasi_errno_t {
...
pub fn thread_spawn<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    method: WasmPtr<u8, M>,
    method_len: M::Offset,
    user_data: u64,
...
pub fn thread_id<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    ret_tid: WasmPtr<__wasi_tid_t, M>,
) -> __wasi_errno_t {
...
pub fn thread_parallelism<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn process_spawn<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    name: WasmPtr<u8, M>,
    name_len: M::Offset,
...
///
/// Returns a bus process id that can be used to invoke calls
pub fn bus_open_local<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    name: WasmPtr<u8, M>,
    name_len: M::Offset,
    reuse: __wasi_bool_t,
...
///
/// Returns a bus process id that can be used to invoke calls
pub fn bus_open_remote<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    name: WasmPtr<u8, M>,
    name_len: M::Offset,
    reuse: __wasi_bool_t,
...
fn bus_open_local_internal<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    name: String,
    reuse: bool,
...
/// ## Parameters
///
/// * `bid` - Handle of the bus process handle<D> to be closed
pub fn bus_close<D>(ctx: ContextMut<'_, WasiEnv, D>, bid: __wasi_bid_t) -> __bus_errno_t {
...
pub fn bus_call<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    bid: __wasi_bid_t,
...
/// * `format` - Format of the data pushed onto the bus
/// * `buf` - The buffer where data to be transmitted is stored
pub fn bus_subcall<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    parent: __wasi_cid_t,
    keep_alive: __wasi_bool_t,
    topic: WasmPtr<u8, M>,
...
pub fn bus_poll<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
/// * `format` - Format of the data pushed onto the bus
/// * `buf` - The buffer where data to be transmitted is stored
pub fn call_reply<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    cid: __wasi_cid_t,
    format: __wasi_busdataformat_t,
    buf: WasmPtr<u8, M>,
...
/// ## Parameters
///
/// * `cid` - Handle of the bus call handle to <D>be dropped
pub fn call_close<D>(ctx: ContextMut<'_, WasiEnv, D>, cid: __wasi_cid_t) -> __bus_errno_t {
    let env = ctx.state();
    let bus = env.runtime.bus();
...
pub fn ws_connect<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    url: WasmPtr<u8, M>,
    url_len: M::Offset,
...
/// file handle
pub fn http_request<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    url: WasmPtr<u8, M>,
    url_len: M::Offset,
    method: WasmPtr<u8, M>,
...
pub fn http_status<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn port_bridge<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_unbridge<D>(ctx: ContextMut<'_, WasiEnv, D>) -> __wasi_errno_t {
...
pub fn port_dhcp_acquire<D>(ctx: ContextMut<'_, WasiEnv, D>) -> __wasi_errno_t {
...
pub fn port_addr_add<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_addr_remove<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_addr_clear<D>(ctx: ContextMut<'_, WasiEnv, D>) -> __wasi_errno_t {
...
pub fn port_mac<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_addr_list<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_gateway_set<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    ip: WasmPtr<__wasi_addr_t, M>,
) -> __wasi_errno_t {
...
pub fn port_route_add<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn port_route_remove<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    ip: WasmPtr<__wasi_addr_t, M>,
) -> __wasi_errno_t {
...
pub fn port_route_clear<D>(ctx: ContextMut<'_, WasiEnv, D>) -> __wasi_errno_t {
...
pub fn port_route_list<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn sock_status<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn sock_addr_local<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
///
/// * `fd` - Socket that the address is bound to
pub fn sock_addr_peer<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn sock_open<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
...
pub fn sock_get_opt_flag<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    opt: __wasi_sockoption_t,
...
pub fn sock_set_opt_time<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    opt: __wasi_sockoption_t,
...
/// * `fd` - Socket descriptor
/// * `sockopt` - Socket option to be retrieved
pub fn sock_get_opt_time<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    opt: __wasi_sockoption_t,
...
/// * `fd` - Socket descriptor
/// * `sockopt` - Socket option to be retrieved
pub fn sock_get_opt_size<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    opt: __wasi_sockoption_t,
...
pub fn sock_join_multicast_v4<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn sock_leave_multicast_v4<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    multiaddr: WasmPtr<__wasi_addr_ip4_t, M>,
    iface: WasmPtr<__wasi_addr_ip4_t, M>,
...
/// * `multiaddr` - Multicast group to joined
/// * `interface` - Interface that will join
pub fn sock_join_multicast_v6<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
/// * `multiaddr` - Multicast group to leave
/// * `interface` - Interface that will left
pub fn sock_leave_multicast_v6<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    multiaddr: WasmPtr<__wasi_addr_ip6_t, M>,
    iface: u32,
...
pub fn sock_bind<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn sock_listen<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    backlog: M::Offset,
) -> __wasi_errno_t {
...
pub fn sock_accept<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
pub fn sock_connect<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    addr: WasmPtr<__wasi_addr_port_t, M>,
) -> __wasi_errno_t {
...
pub fn sock_recv<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
///
/// Number of bytes stored in ri_data and message flags.
pub fn sock_recv_from<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    ri_data: WasmPtr<__wasi_iovec_t<M>, M>,
    ri_data_len: M::Offset,
...
pub fn sock_send<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
...
///
/// Number of bytes transmitted.
pub fn sock_send_to<M: MemorySize, D>(
    ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    si_data: WasmPtr<__wasi_ciovec_t<M>, M>,
    si_data_len: M::Offset,
    ...
    let bytes_written = wasi_try_ok!(__sock_actor_mut(
        ...
        |socket| { socket.send_to::<M, D>(&ctx, memory, iovs_arr, addr) }
    ));
...
///
/// Number of bytes transmitted.
pub unsafe fn sock_send_file<M: MemorySize, D>(
    mut ctx: ContextMut<'_, WasiEnv, D>,
    sock: __wasi_fd_t,
    in_fd: __wasi_fd_t,
    offset: __wasi_filesize_t,
    ...
    while (count > 0) {
        ...
        let bytes_written = wasi_try_ok!(__sock_actor_mut(
            ...
            |socket| {
                let buf = (&buf[..]).to_vec();
                socket.send_bytes::<M, D>(Bytes::from(buf))
            }
        ));
