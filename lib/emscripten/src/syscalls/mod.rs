...
pub fn ___syscall3(ctx: ContextMut<'_, EmEnv, ()>, _which: i32, mut varargs: VarArgs) -> i32 {
    ...
    let buf_addr = emscripten_memory_pointer!(ctx, ctx.state().memory(0), buf) as *mut c_void;
...
pub fn ___syscall4(ctx: ContextMut<'_, EmEnv, ()>, _which: c_int, mut varargs: VarArgs) -> c_int {
    ...
    let buf_addr = emscripten_memory_pointer!(ctx, ctx.state().memory(0), buf) as *const c_void;
...
pub fn ___syscall42(ctx: ContextMut<'_, EmEnv, ()>, _which: c_int, mut varargs: VarArgs) -> c_int {
    ...
    let emscripten_memory = ctx.state().memory(0);
...
pub fn ___syscall192(mut ctx: ContextMut<'_, EmEnv, ()>, _which: c_int, mut varargs: VarArgs) -> c_int {
    ...
    if fd == -1 {
        ...
        let real_ptr = emscripten_memory_pointer!(ctx, ctx.state().memory(0), ptr) as *const u8;
...
pub fn ___syscall145(ctx: ContextMut<'_, EmEnv, ()>, _which: c_int, mut varargs: VarArgs) -> i32 {
    ...
    unsafe {
        for i in 0..iovcnt {
            let guest_iov_addr =
                emscripten_memory_pointer!(ctx, ctx.state().memory(0), (iov + i * 8))
                    as *mut GuestIovec;
            let iov_base =
                emscripten_memory_pointer!(ctx, ctx.state().memory(0), (*guest_iov_addr).iov_base)
                    as *mut c_void;
...
pub fn ___syscall191(ctx: ContextMut<'_, EmEnv, ()>, _which: i32, mut varargs: VarArgs) -> i32 {
    ...
    let rlim_ptr = emscripten_memory_pointer!(ctx, ctx.state().memory(0), rlim_emptr) as *mut u8;
...
pub fn ___syscall340(ctx: ContextMut<'_, EmEnv, ()>, _which: c_int, mut varargs: VarArgs) -> c_int {
    ...
    if old_limit != 0 {
        ...
        let buf_ptr = emscripten_memory_pointer!(ctx, ctx.state().memory(0), old_limit) as *mut u8;
